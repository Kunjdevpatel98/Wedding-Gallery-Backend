...
import com.wedding.gallery.security.AuthTokenFilter;
import com.wedding.gallery.security.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth.requestMatchers("/api/auth/**").permitAll()
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/highlights/**").permitAll()
